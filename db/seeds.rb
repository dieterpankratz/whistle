...
trip_5 = Trip.create!(user_id: user_5.id, start_lat: 52.506890, start_long: 13.391410, end_lat: 52.491290, end_long: 13.416200, start_point: "Berlin", end_point: "Berlin")
